...
if('undefined' !== typeof window) {
    window.DEERWorker = window.DEERWorker ?? new Worker('https://localhost:5500/js/worker.js', { type: 'module' })
}
const worker = ('undefined' !== typeof WorkerGlobalScope) ? undefined : window?.DEERWorker ?? new Worker('https://localhost:5500/js/worker.js', { type: 'module' })
